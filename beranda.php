...
?>
    ...
    <body>
      ...
      <div id="user-nav" class="navbar navbar-inverse">
        <ul class="nav">
          <li class="dropdown" id="profile-messages"><a title="Selamat datang" href="index.php" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i> <span class="text">Selamat datang <?php echo $r['nama_user']; ?></span><b class="caret"></b></a>
      ...
      <div id="sidebar"><a href="beranda.php" class="visible-phone"><i class="icon icon-home"></i> Beranda</a>
        <ul>
          ...
          ?>
            ...
            <li> <a href="entri_referensi.php"><i class="icon icon-tasks"></i> <span>Data makanan</span></a> </li>
            <li> <a href="entri_order.php"><i class="icon icon-shopping-cart"></i> <span>Data Orderan</span></a> </li>
            <li> <a href="entri_transaksi.php"><i class="icon icon-inbox"></i> <span>Data Transaksi</span></a> </li>
      ...
      <div class="row-fluid">
        <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Restaurant <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">by Prince Lukas</a> </div>
      </div>
