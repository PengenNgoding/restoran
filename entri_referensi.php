...
?>
    ...
    <body>
      ...
      <!--Header-part-->
      <div id="header">
        <h1><a href="entri_referensi.php">Data makanan</a></h1>
      </div>
      <!--close-Header-part-->
      ...
      <!--close-top-serch-->
      <!--sidebar-menu-->
      <div id="sidebar"><a href="entri_referensi.php" class="visible-phone"><i class="icon icon-tasks"></i> <span>Data makanan</span></a>
        <ul>
          <?php
          if ($r['id_level'] == 1) {
          ?>
            <li><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
            <li class="active"> <a href="entri_referensi.php"><i class="icon icon-tasks"></i> <span>Data makanan</span></a> </li>
      ...
      <div id="content">
        ...
        <div id="content-header">
          <div id="breadcrumb"> <a href="entri_referensi.php" title="Go to here" class="tip-bottom"><i class="icon icon-tasks"></i> Data makanan</a></div>
        </div>
        <!--End-breadcrumbs-->
      ...
      <div class="row-fluid">
        <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Restaurant <a href="">by Prince Lukas</a> </div>
      </div>
