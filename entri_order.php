...
?>
    ...
    <body>
      ...
      <!--Header-part-->
      <div id="header">
        <h1><a href="entri_order.php">Data Orderan</a></h1>
      </div>
      <!--close-Header-part-->
      ...
      <!--close-top-serch-->
      <!--sidebar-menu-->
      <div id="sidebar"><a href="entri_order.php" class="visible-phone"><i class="icon shopping-cart"></i> <span>Data Orderan</span></a>
        <ul>
          <?php
          if ($r['id_level'] == 1) {
          ?>
            ...
            <li class="active"> <a href="entri_order.php"><i class="icon icon-shopping-cart"></i> <span>Data Orderan</span></a> </li>
      ...
      <div id="content">
        ...
        <div id="content-header">
          <div id="breadcrumb"> <a href="entri_order.php" title="Go to here" class="tip-bottom"><i class="icon icon-tasks"></i> Data Orderan</a></div>
        </div>
        <!--End-breadcrumbs-->
